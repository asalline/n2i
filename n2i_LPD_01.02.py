...
def train_network(net, n_train=300, batch_size=25): #g_train, g_test, f_train, f_test, 
    ...
    for i in range(n_train):
        ...
        outs = net(f_batch2.float(), g_batch.float(), operator_split, domain, num_of_splits, averaged)
...
running_loss, running_test_loss, ready_to_eval = train_network(LPD_net, n_train=30001, batch_size=1) # g_train, g_test, f_train, f_test
